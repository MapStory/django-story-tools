...
from story_tools.models import Frame
from story_tools.forms import FrameForm
from story_tools.utils import unicode_csv_dict_reader
...
def _write_frames(data, get_props, id_collector, mapobj, overwrite, form_mode):
    i = None
    errors = []
...
def frames(req, mapid):
    '''management of frames for a given mapid'''
    if req.method == 'GET':
